import { Rate, Button, Dropdown, Input, Popconfirm, message } from "antd";
...
import { IReviews } from "types/backend";
...
interface IProps {
  ...
  userReview: IReviews | null;
  bookIdModal?: number;
}
const { TextArea } = Input;

const ActionReview = (props: IProps) => {
  const { rating, setRating, comment, setComment, userReview, bookIdModal } =
    props;
